...
namespace Hanji.Client
{
    ...
    public class HanjiWebSocketClientOptions
    {
        public int? ReconnectionTimeoutInSec { get; init; }
        public int? ErrorReconnectionTimeoutInSec { get; init; }
    }

    public class HanjiWebSocketClient(
        string url,
        HanjiWebSocketClientOptions? options = null,
        ILogger<HanjiWebSocketClient>? logger = null) : IDisposable
    {
        ...
        private readonly HanjiWebSocketClientOptions? _options = options;
        private readonly ILogger<HanjiWebSocketClient>? _logger = logger;
